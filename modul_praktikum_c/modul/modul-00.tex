...
\caption{Pemetaan Sub-CPMK ke CPMK}\label{tab:obe-subcpmk-cpmk}\\
\hline
...
\par\addvspace{\ModulMediaskip}
{\small
\begin{modultable}[]{Matriks pemetaan CPMK ke CPL}
...
\caption{Ringkasan minggu, Sub-CPMK, bab, dan alokasi waktu praktikum}\label{tab:obe-rps-ringkas}\\
\hline
