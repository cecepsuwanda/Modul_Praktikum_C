...
\begin{aktivitas}
  ...
  \item Perhatikan kerangka latihan berikut yang merupakan konversi dari Pascal \texttt{prosedur\_upah\_latihan.pas} --- lengkapi definisi fungsi \texttt{input} dan \texttt{cetak} yang masih kosong:
\end{aktivitas}
