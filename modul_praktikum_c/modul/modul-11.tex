...
\begin{modultable}[]{Mode pembukaan file teks dan biner (\texttt{fopen})}
...
\begin{modultable}[]{Fungsi pembacaan dari stream file}
{\small
...
\begin{modultable}[]{Fungsi penulisan ke stream file}
{\small
\begin{tabular}{|>{\raggedright\arraybackslash}p{3.0cm}|>{\raggedright\arraybackslash}p{3.2cm}|>{\raggedright\arraybackslash}p{6.5cm}|}
\hline
...
\begin{modultable}[]{Fungsi posisi file dan pelaporan error}
