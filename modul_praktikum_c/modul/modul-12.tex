...
\begin{modultable}[]{Directive preprocessor yang umum dipakai}
{\small
...
\begin{modultable}[]{Makro praprosesor standar (\texttt{\_\_FILE\_\_}, \texttt{\_\_LINE\_\_}, dll.)}
...
\begin{modultable}[]{Simbol variabel otomatis pada Makefile GNU}
\begin{tabular}{|l|l|}
\hline
...
\begin{modultable}[]{Perintah GDB pengenalan}
\begin{tabular}{|l|p{8cm}|}
\hline
