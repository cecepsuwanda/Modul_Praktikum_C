...
\begin{modultable}[]{Pergeseran standar bahasa C (ISO/ANSI)}
{\small
...
\begin{modultable}[]{Empat tahapan kompilasi dari kode sumber hingga executable}
...
\begin{modultable}[]{Opsi kompilator GCC yang sering dipakai}
...
\begin{modultable}[]{Penjelasan baris demi baris program \texttt{hello.c}}
...
\begin{modultable}[]{Rubrik formatif tugas M1 (program pertama)}
