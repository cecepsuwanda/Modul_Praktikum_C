% ============================================================
% Preamble - Modul Praktikum Pemrograman C (OBE)
% Selaras silabus_praktikum_c.tex
% ============================================================
...
% Long lines in tabular/narasi: kurangi overfull hbox berlebihan
...
% Jarak vertikal seragam untuk gambar, tabel, dan listing
\newlength{\ModulMediaskip}
\setlength{\ModulMediaskip}{\baselineskip}

\definecolor{ckeyword}{rgb}{0.0,0.45,0.7}
\definecolor{cstring}{rgb}{0.6,0.1,0.1}
...
\lstdefinestyle{cstyle}{
  ...
  xleftmargin=15pt,
  xrightmargin=5pt,
  aboveskip=\ModulMediaskip,
  belowskip=\ModulMediaskip
}

\renewcommand{\lstlistlistingname}{Daftar Kode Program}
\renewcommand{\lstlistingname}{Kode Program}
\renewcommand{\figurename}{Gambar}
% Penomoran listing per bab (memerlukan listings terbaru; lihat fallback di bawah)
\lstset{style=cstyle, numberbychapter=true}
...
\usepackage{caption}
% \captionof{table} di modultable: hypcap tidak berlaku; matikan agar log bersih
\captionsetup{font=small, labelfont=bf, skip=\ModulMediaskip, hypcap=false}

% Tabel berjudul di teks (non-float): \begin{modultable}[label-opsional]{Judul}...\end{modultable}
\newenvironment{modultable}[2][]{%
...
% Jarak vertikal untuk gambar (float) agar selaras dengan \ModulMediaskip
\setlength{\textfloatsep}{\ModulMediaskip}
\setlength{\floatsep}{\ModulMediaskip}
\setlength{\intextsep}{\ModulMediaskip}
